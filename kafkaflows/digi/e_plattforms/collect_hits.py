...
if __name__ == '__main__':
    result = dict()
    mapping, title_vlids_per_plattform, reverse_mapping = get_mapping_vlids_sys_num('data/e-plattforms-mapping/')
    vlids, vlids_per_plattform = get_vlids('data/e-plattforms/')

    for p in ['emanus-bau', 'emanus-swa', 'erara-bau']:
